...
const Api = {
    ...
    userRegister: json => request('register', json),
    verifyOTP: json => request('verify-otp', json),
    login: json => request('login', json),
    forgotPassword: json => request('forgot-password', json),
    createPassword: json => request('reset-password', json),
    getVendorList: json => request('vendor-list', json),
    resendOTP: json => request('resend-otp', json),
    sendchattoadmin: json => request('create-web-chat', json),
    sendOneToOneChat: json => request('create-chat', json),
    membershipPlans: json => request('membership-plan', json),
    saveVendorPlan: json => request('save-vendor-plan', json),
    addVendor: json => request('add-vendor', json),
    categoryList: ()=> requestGet('category-list'),
    categoryListForBusinessRegister: ()=> requestGet('get-category'),
    profile: () => requestGet('user-profile'),
    getExecutiveNumber: () => requestGet('get-executive-number'),
};
const LocalStorage = {
    setToken: token => AsyncStorage.setItem('authToken', token),
    getToken: () => AsyncStorage.getItem('authToken'),
    setLocation: token => AsyncStorage.setItem('location', location),
    getLocation: () => AsyncStorage.getItem('location'),
